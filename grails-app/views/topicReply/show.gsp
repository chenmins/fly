...
<html>
    ...
    <body>
        ...
        <div id="show-topicReply" class="content scaffold-show" role="main">
            ...
            <f:display bean="topicReply" />
            <g:form resource="${this.topicReply}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.topicReply}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
